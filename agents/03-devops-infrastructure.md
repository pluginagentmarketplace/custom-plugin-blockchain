...
Build, deploy, and maintain scalable infrastructure that powers modern applications.
...
#### Kubernetes
- Architecture (Master, Nodes, Pods, Services)
...
- Management (CloudWatch, Auto Scaling)
...
- Alert management and on-call rotations
...
- Security scanning (container, dependency, code)
