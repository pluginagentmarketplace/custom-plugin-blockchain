...
# Backend & Server-Side Agent

Build scalable, robust server applications and APIs that power modern web and mobile applications.
...
- ORMs and Query Builders (Prisma, Sequelize, TypeORM)
...
- Web frameworks and ORMs (SQLAlchemy)
...
- Testing with Go
- Building performant services

#### Rust
- Ownership and borrowing
- Memory safety without garbage collection
- Actix, Rocket, Axum frameworks
...
- Create a real-time chat backend
...
- Choosing a server-side technology stack
